...
Hazed image model: I(x) = J(x)t(x) + A(1-t(x)),
where   I is the intensity of a captured image,
...
# used to estimate atmospheric light
...
# transmission map estimation requires to be refined, 
# Guided filter is used to refine
...
if __name__ == '__main__':
    ...
    cv2.imshow('I',src)
    cv2.imshow('J',J)
    #cv2.imwrite("outputs/image.png",J*255)
    cv2.waitKey()